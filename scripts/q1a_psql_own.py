"""
q1a.py  — Top campaigns by purchase conversion rate (PostgreSQL own/denormalized model)
...
# Identical query to 3NF — own model keeps the same messages/campaigns structure
SQL = """
SELECT
    c.campaign_id,
    c.campaign_type,
