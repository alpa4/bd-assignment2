"""
q3_psql_own.py  — Full-text search for products by category keywords
                   (PostgreSQL own/denormalised model)
Assignment 2: Big Data Storage & Retrieval

Same logic as q3_psql.py; difference: category_code is also stored inline
in events, but the FTS search and popularity count still come from the
categories + products + events tables (identical schema to 3NF for this query).
"""
